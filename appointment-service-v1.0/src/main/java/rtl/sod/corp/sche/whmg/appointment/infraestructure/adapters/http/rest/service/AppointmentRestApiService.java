package rtl.sod.corp.sche.whmg.appointment.infraestructure.adapters.http.rest.service;
...
import rtl.sod.corp.sche.whmg.appointment.infraestructure.adapters.http.rest.domain.APIResponse;
import rtl.sod.corp.sche.whmg.appointment.infraestructure.adapters.http.rest.interceptor.Logged;
...
public class AppointmentRestApiService {
	...
	@Inject
	NotifyAppointmentCommandBus cmdBus;
