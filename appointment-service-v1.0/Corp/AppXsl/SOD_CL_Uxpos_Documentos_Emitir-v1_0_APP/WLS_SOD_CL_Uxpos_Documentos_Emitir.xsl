   ...
   <oracle-xsl-mapper:schema>
      ...
      <oracle-xsl-mapper:mapSources>
         <oracle-xsl-mapper:source type="XSD">
            <oracle-xsl-mapper:schema location="WLS_SOD_CL_Uxpos_Documentos_Emitir.xsd"/>
      ...
      <oracle-xsl-mapper:mapTargets>
         <oracle-xsl-mapper:target type="XSD">
            <oracle-xsl-mapper:schema location="UXPOS_Schema.xsd"/>
            <oracle-xsl-mapper:rootElement name="VSS" namespace=""/>
         </oracle-xsl-mapper:target>
      </oracle-xsl-mapper:mapTargets>
      <!--GENERATED BY ORACLE XSL MAPPER 12.2.1.1.0(XSLT Build 160608.1900.0023) AT [THU FEB 22 08:52:19 CLST 2018].-->
   </oracle-xsl-mapper:schema>
            ...
            <FormasPago>
               ...
               <FormaPago
                     ...
                     <xsl:attribute name="tipoPago">
                      ...
                      <xsl:if test="ns0:tipoFormaPag/text() = 5">
